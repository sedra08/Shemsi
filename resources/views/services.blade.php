            ...
            <div class="row" style="height: 550px;">
                ...
                <div class="col-lg">
                    <div class=" d-flex justify-content-center align-items-center"
                        ...
                        <img style="border-radius: 20px;" src="./images/service/image 30.png" alt="wait for image"
                            width="65%" style="z-index: 1;">
                        ...
                        <div class="security">
                            <div class=" bg-white rounded-3" style="padding: 10px 15px 10px 15px;">
                        ...
                        <div style="position: absolute;left: 80px;top: 190px;z-index:0;">
                            <div class="circule d-flex gap-3 pb-2">
                                <div class="rounded-5" style="padding: 2px;background-color:#7ABADD;"></div>
                                <div class="rounded-5" style="padding: 2px;background-color:#7ABADD;"></div>
                                <div class="rounded-5" style="padding: 2px;background-color:#7ABADD;"></div>
                                <div class="rounded-5" style="padding: 2px;background-color:#7ABADD;"></div>
                                <div class="rounded-5" style="padding: 2px;background-color:#7ABADD;"></div>
    ...
    <div class="container-fluid gallery pt-5 pb-5">
        <div class="container">
            ...
            <div class="mt-4 p-3">
                <div class="row">
                    <div class="col-lg-5 ">
                        <img src="./images/service/image 31.png" style="border-radius: 30px;" alt>
                    </div>
                    <div class="col-lg-3">
                        <img src="./images/service/image 36.png" style="border-radius: 30px;" alt>
                    </div>
                    <div class="col-lg-4">
                        <img src="./images/service/image 34.png" style="border-radius: 30px;" alt>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-lg-3">
                        <img src="./images/service/image 35.png" style="border-radius: 30px;" alt>
                    </div>
                    <div class="col-lg-4">
                        <img src="./images/service/image 33.png" style="border-radius: 30px;" alt>
                    </div>
                    <div class="col-lg-5">
                        <img src="./images/service/image 32.png" style="border-radius: 30px;" alt>
                    </div>
                </div>
            </div>
        </div>

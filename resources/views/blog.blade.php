        ...
        <div class="container-fluid mt-5 mb-5 blog">
            <div class="container">
                <div
                    ...
                    <div style="width: 80%;">
                        ...
                        <div
                            ...
                            <div>
                                <img src="./images/blog/image 24.png"
                ...
                <div
                    ...
                    <img src="./images/blog/pexels-daniel-frank-305568 1.png"
                        style="border-radius: 30px;" width="92%" alt>
                </div>
                    ...
                    <div style="width: 80%;">
                        ...
                        <div>
                            <img
                                ...
                                height="300">
                            <img src="./images/blog/image 21.png" height="300"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card text-left p-2"
                                ...
                                <img class="card-img-top" height="200"
                                    src="./images/blog/image 22.png"
                                    style="border-radius: 30px;" alt>
                                <div class="card-body">
                                    <h6 class="card-title">DENTAL</h6>
                                    <h1 style="font-size: 20px;">Regular Dental
                                        care make Your Smile Brighter</h1>
                                    <p class="card-text"
                        ...
                        <div class="col-lg-4">
                            <div class="card text-left p-2"
                                style="width: 80%;border-radius: 30px;">
                                <img class="card-img-top" height="200"
                                    src="./images/blog/image 23.png"
                                    style="border-radius: 30px;" alt>
                                <div class="card-body">
                                    <h6 class="card-title">HYGIENE</h6>
                                    <h1 style="font-size: 20px;">Dental Hygiene
                                        for All Age to Make Smile</h1>
                                    <p class="card-text"
                                        style="font-size: 13px; color: #181945;line-height: 1.5;">Lorem
                                        ipsum is
                                        placeholder text commonly used in the
